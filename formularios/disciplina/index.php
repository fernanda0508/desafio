      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-body">
                <h2 class="card-title text-center">Cadastrar Disciplina</h2>
                <form action="cadastrar.php" method="POST" enctype="multipart/form-data">

                  <div class="mb-3">
                    <label for="nomeDisciplina" class="form-label">Nome Disciplina</label>
                    <input type="text" class="form-control" id="nomeDisciplina" name="nomeDisciplina">
                  </div>
                  <div class="mb-3">
                    <label for="Carga_horaria_semestral" class="form-label">Carga horaria semestral</label>
                    <input type="text" class="form-control" id="Carga_horaria_semestral" name="Carga_horaria_semestral">
                  </div>
                  <div class="mb-3">
                    <label for="Carga_horaria_semanal" class="form-label">Carga horaria semanal</label>
                    <input type="text" class="form-control" id="Carga_horaria_semanal"
                      name="Carga_horaria_semanal">
                  </div>
                  <!-- <div class="mb-3">
                              <label for="areaDisciplina" class="form-label">Área da Disciplina</label>
                              <select class="form-select" id="areaDisciplina" name="areaDisciplina">
